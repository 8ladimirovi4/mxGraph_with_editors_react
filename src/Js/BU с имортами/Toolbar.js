...
mxDefaultToolbar.prototype.separatorImage = 'data:image/gif;base64,R0lGODlhAQARAMQAAHp5f4SBiHNsdHd2fH18hHBrcnh3fX57hHFqcm5rdHt6gm5pcHh1fnx5gJmYnnl4fn98hQAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAACH5BAAAAAAALAAAAAABABEAAAUPYNBAB6EAjzEgQrEkjBMCADs=';
mxDefaultToolbar.prototype.addSeparator = function (icon)
{
    icon = icon || this.separatorImage;
 ...
 */
Toolbar.prototype.dropdownImageHtml = '<img border="0" style="position:absolute;right:4px;top:6px;"' +
    ' src="' + Toolbar.prototype.dropdownImage + '" valign="middle"/>';

/**
 * Defines the background for selected buttons.
 */
Toolbar.prototype.selectedBackground = '#808080';
...
Toolbar.prototype.init = function()
{
    ...
    if (sw >= 400)
    {
        ...
        if (sw >= 440)
        {
            ...
            {
                this.editorUi.menus.edgeStyleChange(menu, '', [mxConstants.STYLE_SHAPE, 'width'], [null, null], 'geIcon geSprite geSprite-noarrow', null, true).setAttribute('title', mxResources.get('line'));
                this.editorUi.menus.edgeStyleChange(menu, '', [mxConstants.STYLE_SHAPE, 'width'], ['link', null], 'geIcon geSprite geSprite-linkedge', null, true).setAttribute('title', mxResources.get('doubleLine'));
            ...
            this.addDropDownArrow(this.edgeShapeMenu, 'geSprite-noarrow', 44, 50, 0, 0, 22, -4);
        }
    ...
    this.addItems(['-', 'bindings'], null, null, [null, 'link']);
};
...
Toolbar.prototype.createTextToolbar = function()
{
    ...
    //NOTE: Workaround in mxPopupMenu for icon items (without text).
 ...
 */
Toolbar.prototype.addItems = function(keys, c, ignoreDisabled, sprites)
{
    var items = [];
    ...
    for (var i = 0; i < keys.length; i++)
    {
        ...
        if (key == '-')
            ...
            items.push(this.addItem('geSprite-' + ((sprites && sprites[i]) ? sprites[i] : key.toLowerCase()), key, c, ignoreDisabled));
    }
