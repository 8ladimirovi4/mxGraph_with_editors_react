BindingsHandler = function (editorUi) {
  webix.protoUI(
    {
      name: 'link',
  ...
  (function () {
    Bindings = function (window, container) {
      this.window = window;
                ...
                rows: [
                  { view: 'label', label: 'Список сигналов:' },
                  {
                    ...
                    columns: [
                      ...
                      {
                        id: 'trash',
                        header: "<span class='webix_icon wxi-trash remove_all' title='" + translate('common.delete_all') + "'></span>",
                        width: 35,
                        template: function (obj, common) {
                          let span = $(common.trashIcon(obj, common));
                          span.attr('title', translate('common.delete'));
